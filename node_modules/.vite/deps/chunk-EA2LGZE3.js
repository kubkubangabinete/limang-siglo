...
} from "./chunk-ORVMXTUM.js";
import {
  require_prop_types
} from "./chunk-DTVBZYZJ.js";
import {
  require_react
...
function breakpoints(styleFunction) {
  const newStyleFunction = (props) => {
    ...
    const extended = themeBreakpoints.keys.reduce((acc, key) => {
      if (props[key]) {
        acc = acc || {};
        acc[themeBreakpoints.up(key)] = styleFunction(_extends4({
          theme
        }, props[key]));
      }
      return acc;
  ...
  newStyleFunction.propTypes = true ? _extends4({}, styleFunction.propTypes, {
...
function createBox(options = {}) {
  ...
  const Box2 = React15.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime4.jsx)(BoxRoot, _extends4({
      as: component,
      ref,
...
function useCurrentColorScheme(options) {
  ...
  const setColorScheme = React18.useCallback((value) => {
    if (!value) {
      ...
      if (value && !joinedColorSchemes.includes(value)) {
        ...
        setState((currentState) => {
          const newState = _extends4({}, currentState);
  ...
  const handleMediaQuery = React18.useCallback((e) => {
    if (state.mode === "system") {
      setState((currentState) => _extends4({}, currentState, {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const theme = _extends4({}, restThemeProp, {
      components,
      colorSchemes,
      cssVarPrefix,
      vars: rootVars,
      ...
      if (key === calculatedColorScheme) {
        Object.keys(scheme).forEach((schemeKey) => {
          if (scheme[schemeKey] && typeof scheme[schemeKey] === "object") {
            theme[schemeKey] = _extends4({}, theme[schemeKey], scheme[schemeKey]);
          } else {
  ...
  const getInitColorSchemeScript2 = (params) => getInitColorSchemeScript(_extends4({
    attribute: defaultAttribute,
    colorSchemeStorageKey: defaultColorSchemeStorageKey,
    defaultMode: designSystemMode,
    defaultLightColorScheme,
...
function createContainer(options = {}) {
  ...
  const Container2 = React20.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime9.jsx)(ContainerRoot, _extends4({
        as: component,
        ownerState,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React21.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime10.jsx)(GridRoot, _extends4({
      ref,
      as: component,
      ownerState,
      className: clsx_m_default(classes.root, className)
...
function createStack(options = {}) {
  ...
  const Stack2 = React22.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime11.jsx)(StackRoot, _extends4({
      as: component,
      ownerState,
      ref,
      className: clsx_m_default(classes.root, className)
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EA2LGZE3.js.map
