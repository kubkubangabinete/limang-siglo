...
export default function Directory4() {
    ...
    <Card style={styles.card} className="ch-card">
      ...
      <div className="pokpok-container">
        ...
        <div style={styles.overlay} className="pokpok-overlay">
          <h1 style={styles.overlayh1}>Chapter 4</h1>
          <p style={styles.overlayp}>Roots of the Problem
          
          <Link className="ch-link ch-active" to="/chapters-directory/chapter-4">
