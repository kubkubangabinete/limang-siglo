...
<div className="american-cards-container"> {/* LABEL + ONCLICK */}
    ...
    <input type="checkbox" id="american-card-checkbox-toggle-4" />
        ...
        <label htmlFor="american-card-checkbox-toggle-2" className="american-2">
            ...
            <div className="american-card-modal">
                <div className="american-card-modal-p-container">
                    ...
                    <p>
						They implemented deceptive laws that only reinforced the land monopoly, land-grabbings, and landlessness. 
                        The preservation of the feudal bondage was made possible through the Bell Trade Act, Laurel-Langley Agreement, and other relevant trade policies. 
                    </p>
                </div>
            </div>
            </div>
        ...
        <label htmlFor="american-card-checkbox-toggle-3" className="american-3">
            <div className="american-card-btn">
                <div className="american-card-image">
                    <img className="american-card-image-img" src="https://media.giphy.com/media/Ql2nGRMNcLTsgfVbDb/giphy.gif"/>
                </div>
                <div className="american-card-title">
        ...
        <label htmlFor="american-card-checkbox-toggle-4" className="american-4">
            <div className="american-card-btn">
                <div className="american-card-image">
                    <img className="american-card-image-img" src="https://media.giphy.com/media/PtbW7yGXisj3y8DsLR/giphy.gif"/>
                </div>
                <div className="american-card-title">
