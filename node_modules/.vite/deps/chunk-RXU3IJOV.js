...
function FocusTrap(props) {
  ...
  const ignoreNextEnforceFocus = React2.useRef();
...
function useControllableReducer(internalReducer, externalReducer, props) {
  ...
  const [nextState, dispatch] = React14.useReducer(combinedReducer, initalState);
  const previousState = React14.useRef(initalState);
  React14.useEffect(() => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RXU3IJOV.js.map
