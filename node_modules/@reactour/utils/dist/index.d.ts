...
declare type PositionsType = 'left' | 'right' | 'top' | 'bottom';
declare type PositionsObjectType = {
    [position: string]: number;
};
declare type CoordType = number[];
declare type CoordsObjectType = {
