...
import sample from '/src/assets/chv-sample1.png';
...
export default function Directory5() {
    ...
    <Card style={styles.card} className="ch-card">
      ...
      <div className="pokpok-container">
        ...
        <div style={styles.overlay} className="pokpok-overlay">
          <h1 style={styles.overlayh1}>Chapter 5</h1>
          <p style={styles.overlayp}>Solutions
          <Link className="ch-link ch-active" to="/chapters-directory/chapter-5">
