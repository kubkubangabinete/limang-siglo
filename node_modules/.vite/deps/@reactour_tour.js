...
var Mask = ({
  ...
  }, import_react.default.createElement("defs", null, import_react.default.createElement("mask", {
    id: maskID
...
function useSizes(step, scrollOptions = {
  ...
  const [transition, setTransition] = (0, import_react3.useState)(false);
  const [observing, setObserving] = (0, import_react3.useState)(false);
  const [isHighlightingObserved, setIsHighlightingObserved] = (0, import_react3.useState)(false);
  const [refresher, setRefresher] = (0, import_react3.useState)(null);
  ...
  const observableRefresher = (0, import_react3.useCallback)(() => {
    setObserving(true);
    const _a = getHighlightedRect(
      target,
      step == null ? void 0 : step.highlightedSelectors,
...
var Badge = ({
  ...
  return import_react6.default.createElement("span", { style: getStyles("badge", {}) }, children);
};
...
var Navigation = ({
  ...
  const Button = ({
    ...
    return import_react8.default.createElement(
      ...
      !hideArrow ? import_react8.default.createElement(
        Arrow,
        {
          styles,
  ...
  return import_react8.default.createElement("div", { style: getStyles("controls", {}), dir: rtl ? "rtl" : "ltr" }, !hideButtons ? prevButton && typeof prevButton === "function" ? prevButton({
    Button,
    setCurrentStep,
    currentStep,
    stepsLength,
    setIsOpen,
    steps
  }) : import_react8.default.createElement(Button, { kind: "prev" }) : null, !hideDots ? import_react8.default.createElement("div", { style: getStyles("navigation", {}) }, Array.from({ length: stepsLength }, (_, i) => i).map((index) => {
    var _a;
    return import_react8.default.createElement(
      "button",
      {
    ...
    setIsOpen,
    steps
  }) : import_react8.default.createElement(Button, null) : null);
};
...
var PopoverContent = ({
  ...
  return import_react5.default.createElement(import_react5.default.Fragment, null, showBadge ? import_react5.default.createElement(Badge2, { styles }, badge) : null, showCloseButton ? import_react5.default.createElement(
    Close2,
    {
      styles,
  ...
  ) : null, import_react5.default.createElement(
    Content2,
    {
  ...
  ), showNavigation ? import_react5.default.createElement(
    Navigation2,
    {
      setCurrentStep,
      currentStep,
...
var Tour = (_a) => {
  ...
  const TourWrapper = Wrapper ? Wrapper : import_react2.default.Fragment;
  return step ? import_react2.default.createElement(TourWrapper, null, import_react2.default.createElement(
    Observables_default,
    {
    ...
    ContentComponent ? import_react2.default.createElement(
      ContentComponent,
      __spreadValues({
        styles,
        setCurrentStep,
...
var TourContext = import_react9.default.createContext(defaultState);
var TourProvider = (_a) => {
  var _b = _a, {
    children,
    defaultOpen = false,
  ...
  const [currentStep, setCurrentStep] = (0, import_react9.useState)(startAt);
  const [steps, setSteps] = (0, import_react9.useState)(defaultSteps);
  const [meta, setMeta] = (0, import_react9.useState)("");
  const [disabledActions, setDisabledActions] = (0, import_react9.useState)(false);
  ...
  return import_react9.default.createElement(TourContext.Provider, { value }, children, isOpen ? import_react9.default.createElement(Tour_default, __spreadValues({}, value)) : null);
};
var Context_default = TourContext;
function useTour() {
  return (0, import_react9.useContext)(TourContext);
}
function withTour(WrappedComponent) {
  const ComponentWithTour = (props) => {
    const tourProps = useTour();
    return import_react10.default.createElement(WrappedComponent, __spreadValues(__spreadValues({}, props), tourProps));
  };
