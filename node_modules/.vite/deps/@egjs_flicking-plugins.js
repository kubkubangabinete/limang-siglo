...
var Parallax = function() {
  ...
  var __proto = Parallax2.prototype;
...
var Fade = function() {
  function Fade2(selector, scale) {
    ...
    this._onMove = function() {
      var flicking = _this._flicking;
      var selector2 = _this._selector;
      var scale2 = _this._scale;
      if (!flicking)
        return;
      var panels = flicking.visiblePanels;
      panels.forEach(function(panel) {
        var progress = panel.outsetProgress;
        var el = panel.element;
        var target = selector2 ? el.querySelector(selector2) : el;
        var opacity = Math.min(1, Math.max(0, 1 - Math.abs(progress * scale2)));
...
var AutoPlay = function() {
  function AutoPlay2(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.duration, duration = _c === void 0 ? 2e3 : _c, _d = _b.direction, direction = _d === void 0 ? DIRECTION.NEXT : _d, _e = _b.stopOnHover, stopOnHover = _e === void 0 ? false : _e;
    this._flicking = null;
    this._timerId = 0;
    this._mouseEntered = false;
    this.play = function() {
      var flicking = _this._flicking;
      var direction2 = _this._direction;
      if (!flicking) {
        return;
      }
      _this.stop();
...
var Arrow = function() {
  function Arrow2(_a) {
    ...
    this._onPrevClick = function() {
      ...
      if (flicking.animating || anchorPoints.length <= 0)
        return;
...
var Sync = function() {
  function Sync2(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.type, type = _c === void 0 ? SYNC.TYPE.CAMERA : _c, _d = _b.synchronizedFlickingOptions, synchronizedFlickingOptions = _d === void 0 ? [] : _d;
    this._flicking = null;
    this._addEvents = function() {
      var type2 = _this._type;
      var synced = _this._synchronizedFlickingOptions;
      synced.forEach(function(_a2) {
        var flicking = _a2.flicking, isSlidable = _a2.isSlidable, isClickable = _a2.isClickable;
    ...
    this._onMove = function(e) {
      ...
      _this._synchronizedFlickingOptions.forEach(function(_a2) {
        var flicking = _a2.flicking;
    ...
    this._synchronizeByIndex = function(activeFlicking, index) {
      var synchronizedFlickingOptions2 = _this._synchronizedFlickingOptions;
      _this._preventEvent(function() {
        synchronizedFlickingOptions2.forEach(function(options) {
          _this._updateClass(options, index);
          var flicking = options.flicking;
          if (flicking === activeFlicking)
            return;
    ...
    this._updateClass = function(_a2, index) {
      var flicking = _a2.flicking, activeClass = _a2.activeClass;
      if (!activeClass)
        return;
...
var Perspective = function() {
  function Perspective2(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.selector, selector = _c === void 0 ? "" : _c, _d = _b.scale, scale = _d === void 0 ? 1 : _d, _e = _b.rotate, rotate = _e === void 0 ? 1 : _e, _f = _b.perspective, perspective = _f === void 0 ? 1e3 : _f;
    this.update = function() {
      _this._onMove();
    };
    this._onMove = function() {
      ...
      var selector2 = _this._selector;
      var scale2 = _this._scale;
      var rotate2 = _this._rotate;
      var perspective2 = _this._perspective;
      if (!flicking)
        return;
      ...
      panels.forEach(function(panel) {
        ...
        var el = panel.element;
        var target = selector2 ? el.querySelector(selector2) : el;
        var panelScale = 1 / (Math.abs(progress * scale2) + 1);
        var rotateDegree = progress > 0 ? Math.min(90, progress * 100 * rotate2) : Math.max(-90, progress * 100 * rotate2);
        var _a2 = horizontal ? [0, rotateDegree] : [rotateDegree, 0], rotateX = _a2[0], rotateY = _a2[1];
  ...
  var __proto = Perspective2.prototype;
  Object.defineProperty(__proto, "selector", {
    get: function() {
      return this._selector;
    },
...
var BulletRenderer = function(_super) {
...
var FractionRenderer = function(_super) {
...
var ScrollBulletRenderer = function(_super) {
...
var Pagination = function() {
  function Pagination2(_a) {
    ...
    } : _h, _j = _b.renderFraction, renderFraction = _j === void 0 ? function(currentClass, totalClass) {
      return '<span class="' + currentClass + '"></span>/<span class="' + totalClass + '"></span>';
    } : _j, _k = _b.fractionCurrentFormat, fractionCurrentFormat = _k === void 0 ? function(index) {
      return index.toString();
    } : _k, _l = _b.fractionTotalFormat, fractionTotalFormat = _l === void 0 ? function(index) {
      return index.toString();
    } : _l, _m = _b.scrollOnChange, scrollOnChange = _m === void 0 ? function(index, ctx) {
...
***************************************************************************** */
//# sourceMappingURL=@egjs_flicking-plugins.js.map
