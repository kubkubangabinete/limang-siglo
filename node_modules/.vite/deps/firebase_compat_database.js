...
var Query = class {
  ...
  startAt(value = null, name3) {
    ...
    return new Query(this.database, query(this._delegate, startAt(value, name3)));
  }
  startAfter(value = null, name3) {
    validateArgCount("Query.startAfter", 0, 2, arguments.length);
    return new Query(this.database, query(this._delegate, startAfter(value, name3)));
  }
  endAt(value = null, name3) {
    validateArgCount("Query.endAt", 0, 2, arguments.length);
    return new Query(this.database, query(this._delegate, endAt(value, name3)));
  }
  endBefore(value = null, name3) {
    validateArgCount("Query.endBefore", 0, 2, arguments.length);
    return new Query(this.database, query(this._delegate, endBefore(value, name3)));
  }
  /**
  ...
  equalTo(value, name3) {
    ...
    return new Query(this.database, query(this._delegate, equalTo(value, name3)));
  }
  /**
