...
var Mask = ({
  ...
  const [wpx, wpy] = (0, import_utils.getPadding)(wrapperPadding);
  const { w, h } = (0, import_utils.getWindow)();
  const width = (0, import_utils.safe)((sizes == null ? void 0 : sizes.width) + px * 2);
  const height = (0, import_utils.safe)((sizes == null ? void 0 : sizes.height) + py * 2);
  const top = (0, import_utils.safe)((sizes == null ? void 0 : sizes.top) - py - wpy / 2);
  const left = (0, import_utils.safe)((sizes == null ? void 0 : sizes.left) - px - wpx / 2);
  ...
  }, /* @__PURE__ */ import_react.default.createElement("defs", null, /* @__PURE__ */ import_react.default.createElement("mask", {
    id: maskID
