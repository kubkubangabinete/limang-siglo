...
import { Accessor, Node, Primitive, Property, Scene, Texture, Transform, TransformContext } from '@gltf-transform/core';
/**
...
/** @hidden */
export declare function traverseNodeParents(node: Node, fn: (parent: Scene | Node) => void): void;
/** @hidden */
