      ...
      <div style={ChaptersContainerStyles}>
        <div className="sol-modal-container">
          <div className="sol-modal-text">
            <h2 className="sol-modal-h2">Chapter 1</h2>
            <h3 className="sol-modal-h3">Introduction</h3>
            <p className="sol-modal-p">
              Have you met any peasants here in the Philippines?
            </p>
            <p className="sol-modal-p">
              This chapter helps us answer and reflect on questions that
              commonly confuse some people -- Who are the peasants exactly?
              Where are they situated? What makes a peasant... a peasant?
            </p>
            <p className="sol-modal-p">
              <i>
